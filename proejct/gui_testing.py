...
class RobotGUI:
    ...
    def draw_grid(self):
        ...
        # Draw S on the start cell.
        self.draw_letter(self.map.start, "S", "white")
        # Draw G on the goal cell.
        self.draw_letter(self.map.goal, "G", "white")
        # Draw R on current robot position.
        self.draw_letter(self.robot.current_position, "R", "white")
